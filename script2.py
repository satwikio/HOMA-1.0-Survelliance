...
# === Configuration ===
BACKEND_URL = "http://192.168.1.64:8000"   # Local backend
WS_URL = "ws://192.168.1.64:8000"          # Local WebSocket
...
class DroneClient:
    ...
    async def send_webrtc_offer(self):
        ...
        try:
            print("🎥 Creating new WebRTC offer...")

            # Check if peer connection is closed and recreate if needed
            if self.pc.connectionState == "closed" or self.pc.connectionState == "failed":
                print("♻️  RTCPeerConnection is closed, recreating...")
