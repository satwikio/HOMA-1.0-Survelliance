...
class DroneClient:
    ...
    async def start_webrtc(self):
        ...
        # CRITICAL: Configure STUN servers for NAT traversal
        ...
        print(f"✅ Video track added with STUN servers")
        ...
        async def on_ice(candidate):
            if candidate:
                print(f"🧊 Drone ICE candidate: {candidate.candidate[:50]}...")
                msg = {
                    "type": "ice_candidate",
                    "drone_id": DRONE_ID,
                    "candidate": {
                ...
                print(f"✅ ICE candidate sent to backend")
            else:
