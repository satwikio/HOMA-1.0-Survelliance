...
class HumanDetector:
    ...
    def __init__(
        ...
        print("\n" + "=" * 80)
        print("🔥 MINIMAL Human DETECTOR READY")
    ...
    def _setup_logging(self):
        ...
        self.logger = logging.getLogger("Human_detector_minimal")
        self.logger.setLevel(logging.INFO)
        self.logger.handlers.clear()

        fh = logging.FileHandler(logs_dir / "Human_detector_minimal.log")
    ...
    def _log_stats(self):
        ...
        log = (
            f"\n{'='*80}\n"
            f"🔥 MINIMAL Human DETECTOR STATS ({elapsed:.1f}s)\n"
            f"{'='*80}\n"
