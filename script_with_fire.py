...
BACKEND_URL = os.getenv("BACKEND_URL", "http://182.68.1.54:8001")
WS_URL = os.getenv("WS_URL", "ws://182.68.1.5:8001")
...
from object_detector import ObjectDetectorSimulator
...
class DroneClient:
    def __init__(self):
        ...
        # Object detection - focus on fire detection
        self.detector = ObjectDetectorSimulator(
